...
const RightHeader: React.FC<RightHeaderProps> = ({ head, isActive, setIsActive }) => {
    return (
        <div className="flex flex-row justify-between items-center relative ">
            ...
            <div
                className="absolute gap-5 h-[55px] right-0 top-0 flex flex-row justify-start items-end border border-[#383838] text-foreground font-thin font-outfit rounded-bl-3xl rounded-tr-3xl w-[25rem] bg-greyish">
                {
