      ...
      <div className="columns-1 md:columns-2 md:gap-3 lg:columns-3">
        {
          Projects.map((project) => {
            return (
              <div className="relative rounded-3xl bg-primary break-inside-avoid group">
                <Eye
                  onClick={() => handelClick(project)}
                  size={30}
                  className="absolute text-highlight p-1 bg-greyish rounded-md top-[25%] left-[45%] hidden group-hover:block group-hover:z-30 cursor-pointer" />
                <img src={project.images[0]} className="w-full rounded-xl group-hover:scale-110" />
