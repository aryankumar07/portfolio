    ...
    return (
        <div className="p-5 overflow-x-hidden">
            ...
            <div className="flex flex-row justify-center items-center gap-3 mt-8 ">
                ...
                <DownloadIcon size={20} className="text-foreground hover:text-highlight" onClick={() => window.open("https://drive.google.com/file/d/195oi7jOpksM4t-or1fdmRYPV8wGwJAW8/view?usp=sharing", "_blank")} />
            </div>
        </div>
    )
}
