...
const AboutMeBody = (
  <div className="h-auto w-auto m-5">
    ...
    <div className="flex flex-row gap-2 w-full overflow-x-auto overflow-visible h-60 mt-7 scrollbar  scrollbar-thumb-highlight scrollbar-thumb-rounded-full">
      {
        Facts.map((fact) => {
          return (
            <div key={fact.quote} className="min-w-[100%] relative xl:min-w-[48%] h-36 border border-[#383838] bg-greyish rounded-2xl mt-16 ">
