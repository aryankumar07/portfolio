...
const Popup: React.FC<PopupProps> = ({
    ...
    return (
        <div className="fixed flex inset-0 justify-center items-center overflow-x-hidden overflow-y-auto z-50 bg-neutral-800/70">
            <div className={`flex fixed  justify-center items-center text-foreground rounded-xl bg-primary h-auto w-full
